 ...
 *
 */
public class ListaEnlazadaGenerica_1<T> extends ListaGenerica<T> {
    ...
    public ListaGenerica<T> clonar() {
        ...
        ListaGenerica<T> nueva = new ListaEnlazadaGenerica_1<T>();
        this.comenzar();
        while (!this.fin()) {
    ...
    public boolean equals(Object o) {
        ...
        ListaEnlazadaGenerica_1<T> lista = (ListaEnlazadaGenerica_1<T>) o;
